...
$(function () {
  ...
  var $authControl = $('#auth_user-control')
  ...
  // Authentication: none
  $authControl.find("[data-auth_user='none']").click(function (event) {
    event.preventDefault()
    window.auth = null
    $selectedAuthentication.text('none')
    $authControl.find("[data-auth_user]").closest('li').removeClass('active')
    $authControl.find("[data-auth_user='none']").closest('li').addClass('active')
  })
  ...
  $('form.authentication-token-form').submit(function (event) {
    ...
    $authControl.find("[data-auth_user]").closest('li').removeClass('active')
    $authControl.find("[data-auth_user='token']").closest('li').addClass('active')
  ...
  $('form.authentication-basic-form').submit(function (event) {
    ...
    $authControl.find("[data-auth_user]").closest('li').removeClass('active')
    $authControl.find("[data-auth_user='basic']").closest('li').addClass('active')
  ...
  $('form.authentication-session-form').submit(function (event) {
    ...
    $authControl.find("[data-auth_user]").closest('li').removeClass('active')
    $authControl.find("[data-auth_user='session']").closest('li').addClass('active')
